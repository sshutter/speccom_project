Rails.application.routes.draw do
  ...
  get "/my_inventory", to: "my_invent#my_inventory", as: "my_inventory"
  post "/my_inventory", to: "my_invent#my_inventory2", as: "my_inventory2"
  get "/my_inventory", to: "my_invent#delete_item", as: "delete_item"
  post "/my_inventory", to: "my_invent#change_ena", as: "change_enable"
